/*
* MARK 如果要复用轮廓点，需要将pointElements缓存起来
*  但是会引入其他bug，例如拖拽某元素的轮廓点时更新的却是其他元素
*  因为多个元素使用这个钩子函数，共享相同的数据造成状态混乱
*  使用工厂函数解决这个问题
* */
...
export function createUseDragResize () {
  return function useDragResize (targetSelector: string | HTMLElement, resizeOptions: any = {}) {
