...
declare type WatcherEmit = 'ended' | 'pause' | 'playing' | 'contextCreated' | 'sourceCreated' | 'changeVisualType' | 'timeupdate' | 'abort' | 'progress' | 'volumeupdate' | 'loadeddata' | 'loadedBuffer' | 'canplay' | 'changePlay' | 'loopWay';
